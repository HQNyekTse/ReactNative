...
import { View, Text, ImageBackground, SafeAreaView, TouchableOpacity, Alert } from 'react-native';
...
export default class CameraScreen extends Component {
  ...
  render() {
    ...
    if (imageSrc){
        return(
            <ImageBackground resizeMode="stretch" source={{ uri:imageSrc }} style={{ flex:1, justifyContent:'flex-end' }}>
    ...
    return(
        <SafeAreaView style={{ flex: 1 }}>
                ...
                >
                    ...
                    >
                        <TouchableOpacity onPress={this.handleTakePictures} style={{}}>
                            <Ionicons
                                name="md-camera"
                                color="white"
                                size={32}
